...
contract MoodNftTest is Test {
    MoodNft moodNft;
    string public constant HAPPY_SVG_IMAGE_URI = //created by running the following command in the terminal, and then prepending the data part: ase64 -i happy.svg
    ...
    function testViewTokenURI() public {
        ...
        vm.prank(USER);
        moodNft.flipMood(0);
        console.log(moodNft.tokenURI(0));   //by default, happy
    }
}
